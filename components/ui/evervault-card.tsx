...
import React, { useState, useEffect, ReactNode, SVGProps, MouseEvent } from "react";
...
export const EvervaultCard = ({
  ...
  return (
    <div
      className={cn(
        "p-0.5 bg-white bg-opacity-10 aspect-square  flex items-center justify-center w-full h-full relative rounded-lg",
        className
      )}
    >
      <div
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative h-auto w-auto p-6 flex items-center justify-center text-white font-bold text-4xl">
            <div className="absolute w-full h-full bg-transparent group-hover/card:bg-black/[0.8] blur-xl transition-colors duration-200" />
