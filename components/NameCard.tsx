...
export function NameCard() {
  return (
    <div className="w-full h-full flex flex-col justify-center items-center gap-2 bg-white bg-opacity-10 text-white rounded-lg my-4 sm:my-5 md:my-6 lg:my-8 xl:my-0">
